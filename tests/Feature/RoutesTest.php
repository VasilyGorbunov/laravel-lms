...
it('has a route for the course details page page', function () {
...
it('has a route for the watch episodes page with optional episode parameters', function () {
    $course = Course::factory()
        ->for(User::factory()->instructor(), 'instructor')
...
it('it only show episodes to authenticated users', function () {
    $course = Course::factory()
        ->for(User::factory()->instructor(), 'instructor')
