...
it('belong to an instructor', function () {
...
it('has the episode length', function () {
    ...
    expect($courseA->formatted_length)->toBe('2 hrs 30 mins');
    expect($courseB->formatted_length)->toBe('1 hr 1 min');
    expect($courseC->formatted_length)->toBe('0 mins');
